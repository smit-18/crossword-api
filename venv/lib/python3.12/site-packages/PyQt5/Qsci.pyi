...
class QsciScintillaBase(QtWidgets.QAbstractScrollArea):
    ...
    def toMimeData(self, text: typing.Union[QtCore.QByteArray, bytes, bytearray], rectangular: bool) -> typing.Optional[QtCore.QMimeData]: ...
    ...
    def SendScintillaPtrResult(self, msg: int) -> typing.Optional[PyQt5.sip.voidptr]: ...
    @typing.overload
    def SendScintilla(self, msg: int, wParam: typing.Any = ..., lParam: int = ...) -> int: ...
    @typing.overload
    def SendScintilla(self, msg: int, wParam: int, lParam: typing.Optional[PyQt5.sip.voidptr]) -> int: ...
    @typing.overload
...
class QsciScintilla(QsciScintillaBase):
    ...
    def showUserList(self, id: int, list: typing.Iterable[typing.Optional[str]]) -> None: ...
    ...
    def setAutoCompletionWordSeparators(self, separators: typing.Iterable[typing.Optional[str]]) -> None: ...
...
class QsciAbstractAPIs(QtCore.QObject):
    ...
    def callTips(self, context: typing.Iterable[typing.Optional[str]], commas: int, style: QsciScintilla.CallTipsStyle, shifts: typing.Iterable[int]) -> typing.List[str]: ...
    def autoCompletionSelected(self, selection: typing.Optional[str]) -> None: ...
    def updateAutoCompletionList(self, context: typing.Iterable[typing.Optional[str]], list: typing.Iterable[typing.Optional[str]]) -> typing.List[str]: ...
    def lexer(self) -> typing.Optional['QsciLexer']: ...
...
class QsciStyle(PyQt5.sip.wrapper):
    ...
    @typing.overload
    def __init__(self, style: int, description: typing.Optional[str], color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor], paper: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor], font: QtGui.QFont, eolFill: bool = ...) -> None: ...
    @typing.overload
